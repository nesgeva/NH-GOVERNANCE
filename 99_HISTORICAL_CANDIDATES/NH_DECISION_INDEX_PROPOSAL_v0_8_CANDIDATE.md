...
Result on v0_7 (identity confirmed `424a6133…`): **NOT PASS**, three issues, all verified and corrected here; everything else passed (base identity, all seven source/receipt identities, both package-complete scopes, the UE5 boundary, the cleanup counts confirmed against Git, the deferred seven-web item).
