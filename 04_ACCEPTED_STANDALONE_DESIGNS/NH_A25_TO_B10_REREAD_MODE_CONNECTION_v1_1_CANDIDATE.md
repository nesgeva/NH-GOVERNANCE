# NH_A25_TO_B10_REREAD_MODE_CONNECTION_v1_1_CANDIDATE.md
...
|---|---|---|
| **Missing** (no committed assignment — including, until the §10 compatibility package exists, the settled manual reread with no new-information relationship) | Exactly the current §8 behavior: `dependency_blocked_held` at RR2 — nothing proceeds, no mode invented, `thread_membership_v1` not borrowed | `assignment_missing` |
...
**File created:** `NH_A25_TO_B10_REREAD_MODE_CONNECTION_v1_1_CANDIDATE.md`
— the only file created by this task, from the verified v1_0 (preserved
unchanged as historical candidate provenance). **Nothing existing was modified:**
...
*End of `NH_A25_TO_B10_REREAD_MODE_CONNECTION_v1_1_CANDIDATE.md` —
